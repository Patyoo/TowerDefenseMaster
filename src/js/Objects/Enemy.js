class Enemy{
    ...
    matchAsset(){
        switch(this.identity){
            ...
            case 4: this.image.src="./Assets/Enemy/whiteSquare.png"; this.health=45; this.virtualHealth=this.health; this.reward=12; break;
            case 5: this.image.src="./Assets/Enemy/whiteTriangle.png"; this.health=60; this.virtualHealth=this.health; this.reward=15; break;
            case 6: this.image.src="./Assets/Enemy/redCircle.png"; this.health=100; this.virtualHealth=this.health; this.reward=25; break;
            case 7: this.image.src="./Assets/Enemy/redSquare.png"; this.health=125; this.virtualHealth=this.health; this.reward=35; break;
            case 8: this.image.src="./Assets/Enemy/redTriangle.png"; this.health=150; this.virtualHealth=this.health; this.reward=45; break;
        }
    }
    move(){
